...
### ตารางราคาในหน้าสินค้า

ท้ายหน้ารายละเอียดสินค้าแสดง**ตารางราคาเดียวของทั้งเว็บ** — ทุกระบบรวมอยู่ในตารางเดียว
คอลัมน์มีแค่ ลำดับ / รายการ / ราคา (บาท) โดย

- เอาเฉพาะ**รายการพื้นขาว**ในไฟล์ excel (ราคานอกเกณฑ์ราคากลาง) คือตัวระบบแต่ละตัว
  แถวพื้นเขียว (ราคากลาง ICT) ไม่แสดง
- ชื่อรายการใช้**ชื่อระบบจากไฟล์ word** ทั้งอังกฤษและไทย (ค่า `"name"` / `"nameTh"`
  ใน `products.json`) ไม่ใช่ชื่อรายการในไฟล์ excel
- แถวของสินค้าหน้านั้นถูกเน้นสี และราคาของมันถูกชูขึ้นมาเหนือตาราง
- ราคาผูกกับไฟล์ excel ผ่านค่า `"quotation"` + `"quotationItem"` ของสินค้าใน
  `products.json` (`quotationItem` ต้องตรงกับ `name` ของรายการใน `quotations.json`
  ทุกตัวอักษร) — แก้ราคาที่ `.xlsx` ใน `quotations-source/` แล้ว build ใหม่
  ตารางบนเว็บเปลี่ยนตาม
