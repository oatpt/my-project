...
ท้ายหน้ารายละเอียดสินค้าแสดงตารางราคาของโครงการนั้นทั้งตาราง (รายการ จำนวน หน่วย
ราคาต่อหน่วย ราคารวม ยอดรวม และหมายเหตุ ตามไฟล์ excel) โดย

- แถวของสินค้าหน้านั้นถูก**เน้นสี** และราคาของมันถูกชูขึ้นมาเหนือตาราง
- สินค้าตัวไหนคือรายการไหนในตาราง กำหนดที่ค่า `"quotationItem"` ของสินค้านั้นใน
  `products.json` (ต้องตรงกับ `name` ของรายการใน `quotations.json` ทุกตัวอักษร)
  ส่วน `"quotation"` เลือกว่าใช้ตารางของโครงการไหน
- แก้ราคาที่ไฟล์ `.xlsx` ใน `quotations-source/` แล้ว build ใหม่ ตารางบนเว็บเปลี่ยนตาม
