...
สินค้า 12 ตัวจากเอกสารสองไฟล์นี้ไม่มีใบเสนอราคา `.xlsx` ราคาเขียนอยู่ในเอกสาร word
ของตัวเอง จึงเก็บไว้ที่ `"price"` ของสินค้านั้นใน `products.json` แล้วต่อท้ายตารางให้เอง
...
เว็บจึงไม่มีจำนวนด้วย) รูปของสินค้าทุกตัวดึงมาจากรูปในเอกสารเอง

```jsonc
"price": 47630    // ราคาต่อหน่วย (บาท) — ใส่แค่ตัวเลข ไม่มีหน่วยกำกับ
```

ตารางมีคอลัมน์เดียวสำหรับตัวเลข จึงไม่แสดงหน่วย สายใยแก้วนำแสงที่เอกสารเขียนว่า
"94 บาทต่อเมตร" ขึ้นเป็น `94` เฉย ๆ เหมือนรายการอื่น
