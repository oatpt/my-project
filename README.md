...
| `public/files/_quotations/` | `.pdf` ที่สร้างจากไฟล์ข้างบน | ไฟล์ที่ลูกค้าโหลดจากหน้าเว็บ |
...
แล้วสั่งพิมพ์หรือบันทึกเป็น PDF ได้จากหน้าเว็บเลย โดย

- **จำนวนตั้งไว้ที่ 1 ทุกรายการ** ตารางที่เห็นตอนเปิดจึงเป็นราคาต่อหน่วยล้วน ๆ
  ผู้ใช้ค่อยใส่จำนวนที่ต้องการเอง ราคารวมแต่ละแถวและยอดรวมคิดให้ใหม่ทันที
- **วันที่เป็นวันที่วันนี้** ไม่ใช่วันที่ในไฟล์ต้นฉบับ
- แก้ได้ทุกช่อง เพิ่ม/ลบรายการได้ กด "เริ่มใหม่" เพื่อกลับไปเป็นค่าตั้งต้น
