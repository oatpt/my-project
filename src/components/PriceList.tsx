...
// ที่ระบายสีเขียวไว้ถูกข้าม) ที่มีหน้าสินค้าของตัวเอง รายการที่ไม่ match กับสินค้าตัวไหน
// เลยจะถูกข้าม ทุกแถวใช้ชื่อจากเว็บเป็นชื่อหลัก มีชื่อไทยกำกับถ้ามี และกดไปหน้ารายละเอียดได้
